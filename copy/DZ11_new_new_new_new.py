...
class Record:
    def __init__(self, name4, *args):
        self.name = name4
        self.phones = []
        self.current_phone1= args
        self.add_phone(self.current_phone)
        self._birthday='00.00.0000'
        #print(self.current_phone1)
        #print(self.current_phone)
   
    @property
    def current_phone(self):        
        return self.current_phone1

    @current_phone.setter
    def current_phone(self):
        if len (self.current_phone1) < 10:
            self.current_phone=self.current_phone1
        else:
    ...
    def add_phone(self, *args) -> None:
        ...
        #self.phones.append(self.current_phone)
...
def main():
    ...
    def show_func(N=1):
        #paginator = c_b.iterator(1)        
        for i in range (0, N):
           print(paginator.popitem())
